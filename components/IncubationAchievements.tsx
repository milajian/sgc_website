...
const achievements = [{
  ...
  image: getImagePath("/assets/incubation-chip-embedded-new.png")
}, {
  name: "轴向电机解决方案",
  description: "革命性的PCB定子轴向电机技术",
  highlights: ["适用于工业电机（风机、水泵等）", "机器人（仿生机器人、机械臂）", "无人机，发电机", "新能源汽车驱动", "交通运输与船舶应用"],
  image: getImagePath("/assets/incubation-motor-applications-new.png")
}, {
  name: "埋嵌工艺产品",
  ...
  image: getImagePath("/assets/incubation-design-thermal.png")
}];
