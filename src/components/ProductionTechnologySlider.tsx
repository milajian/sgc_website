...
import productionThickCopperEtching from "@/assets/production-thick-copper-etching.png";
import productionThickCopperLamination from "@/assets/production-thick-copper-lamination.png";
import productionLaserDrillingPlating1 from "@/assets/production-laser-drilling-plating-1.png";
import productionLaserDrillingPlating2 from "@/assets/production-laser-drilling-plating-2.png";
interface Slide {
  title: string;
  subtitle: string;
  content: {
...
const slides: Slide[] = [{
  ...
  content: [{
    ...
    description: "占位描述",
    items: [],
    image: productionThickCopperEtching
  }]
}, {
  title: "6-10 oz厚铜压合填胶",
  subtitle: "占位内容",
  content: [{
    ...
    description: "占位描述",
    items: [],
    image: productionThickCopperLamination
  }]
}, {
  title: "厚铜激光钻孔&电镀填孔（一）",
  subtitle: "占位内容",
  content: [{
    ...
    description: "占位描述",
    items: [],
    image: productionLaserDrillingPlating1
  }]
}, {
  title: "厚铜激光钻孔&电镀填孔（二）",
  subtitle: "占位内容",
  content: [{
    ...
    description: "占位描述",
    items: [],
    image: productionLaserDrillingPlating2
  }]
}];
