...
import productionEtching from "@/assets/production-etching.png";
import productionLamination from "@/assets/production-lamination.png";
import productionDrilling from "@/assets/production-drilling.png";
import productionLaser from "@/assets/production-laser.png";
import productionTesting from "@/assets/production-testing.png";
...
const processSteps = [
  {
    ...
    image: productionEtching
  },
  {
    title: "压合",
    description: "多层板压合",
    items: ["压合填胶", "压合偏位控制", "板厚均匀性"],
    image: productionLamination
  },
  {
    title: "钻孔",
    description: "机械钻孔",
    items: ["孔壁质量", "孔位精度"],
    image: productionDrilling
  },
  {
    title: "激光钻孔、填孔",
    description: "激光精密加工",
    items: ["高深径比激光钻孔", "高深径比激光盲孔填孔"],
    image: productionLaser
  },
  {
    title: "检测与测试",
    description: "全面质量检测",
    items: ["厚铜线圈板开短路测试", "厚铜线圈板电感测试", "厚铜板耐电压测试", "可靠性测试"],
    image: productionTesting
  }
];
